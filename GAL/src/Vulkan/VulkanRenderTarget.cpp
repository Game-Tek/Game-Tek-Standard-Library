...
VulkanRenderTarget::VulkanRenderTarget(VulkanRenderDevice* device, const RenderTargetCreateInfo& imageCreateInfo) : VulkanRenderTargetBase(imageCreateInfo)
{
	const auto image_format = ImageFormatToVkFormat(imageCreateInfo.Format);
