...
void GAL::DX12RenderContext::Present(const DX12RenderDevice* renderDevice,
	GTSL::Range<const GTSL::uint32*> waitSemaphores, GTSL::uint32 imageIndex, DX12Queue queue)
{
